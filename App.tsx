...
const App: React.FC = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-full w-[800px] h-[800px] -translate-x-1/2 -translate-y-1/2 pointer-events-none z-0"
           style={{ background: 'radial-gradient(circle, rgba(240, 185, 11, 0.08) 0%, transparent 60%)' }}>
      </div>

      {/* Main Card Render */}
      <div className="w-full flex justify-center transform transition-transform duration-500 z-10">
        <CrystalCard 
          data={eventData} 
      ...
      {/* Context info */}
      <div className="absolute bottom-8 text-white/20 font-code text-[10px] tracking-[0.2em] uppercase z-0 pointer-events-none">
        SCROLL or CLICK EDGES to NAVIGATE • CLICK DATE to JUMP
      </div>
    </div>
  );
};
